...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ALE [ create_bd_port -dir O ALE ]
  set CE_n [ create_bd_port -dir O CE_n ]
  set CLE [ create_bd_port -dir O CLE ]
  set DIO [ create_bd_port -dir IO -from 7 -to 0 DIO ]
  set RE_n [ create_bd_port -dir O RE_n ]
  set R_nB [ create_bd_port -dir I R_nB ]
  set WE_n [ create_bd_port -dir O WE_n ]

  # Create instance: NAND_Flash_Controller_0, and set properties
  set NAND_Flash_Controller_0 [ create_bd_cell -type ip -vlnv user.org:user:NAND_Flash_Controller:1.0 NAND_Flash_Controller_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins NAND_Flash_Controller_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net NAND_Flash_Controller_0_ALE [get_bd_ports ALE] [get_bd_pins NAND_Flash_Controller_0/ALE]
  connect_bd_net -net NAND_Flash_Controller_0_CE_n [get_bd_ports CE_n] [get_bd_pins NAND_Flash_Controller_0/CE_n]
  connect_bd_net -net NAND_Flash_Controller_0_CLE [get_bd_ports CLE] [get_bd_pins NAND_Flash_Controller_0/CLE]
  connect_bd_net -net NAND_Flash_Controller_0_RE_n [get_bd_ports RE_n] [get_bd_pins NAND_Flash_Controller_0/RE_n]
  connect_bd_net -net NAND_Flash_Controller_0_WE_n [get_bd_ports WE_n] [get_bd_pins NAND_Flash_Controller_0/WE_n]
  connect_bd_net -net Net [get_bd_ports DIO] [get_bd_pins NAND_Flash_Controller_0/DIO]
  connect_bd_net -net R_nB_1 [get_bd_ports R_nB] [get_bd_pins NAND_Flash_Controller_0/R_nB]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins NAND_Flash_Controller_0/s00_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins NAND_Flash_Controller_0/s00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs NAND_Flash_Controller_0/S00_AXI/S00_AXI_reg] SEG_NAND_Flash_Controller_0_S00_AXI_reg
