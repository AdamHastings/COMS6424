...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity bd_NAND_Flash_Controller_0_0_H_gen is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity bd_NAND_Flash_Controller_0_0_TFSM is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity bd_NAND_Flash_Controller_0_0_nfcm_top is
  port (
    CLE : out STD_LOGIC;
    ALE : out STD_LOGIC;
    WE_n : out STD_LOGIC;
...
begin
NAND_Flash_Controller_v1_0_S00_AXI_inst: entity work.bd_NAND_Flash_Controller_0_0_NAND_Flash_Controller_v1_0_S00_AXI
     port map (
      ALE => ALE,
      CE_n => CE_n,
      CLE => CLE,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity bd_NAND_Flash_Controller_0_0 is
  port (
  ...
  attribute NotValidForBitStream of bd_NAND_Flash_Controller_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of bd_NAND_Flash_Controller_0_0 : entity is "bd_NAND_Flash_Controller_0_0,NAND_Flash_Controller_v1_0,{}";
...
inst: entity work.bd_NAND_Flash_Controller_0_0_NAND_Flash_Controller_v1_0
     port map (
      ALE => ALE,
      CE_n => CE_n,
      CLE => CLE,
