...
add_force {/NAND_Flash_Controller_v1_0/NAND_Flash_Controller_v1_0_S00_AXI_inst/slv_reg0} -radix hex {0 0ns} {0040 8ns} {0000 30ns} {001a 50ns} {0018 1000ns}
add_force {/NAND_Flash_Controller_v1_0/NAND_Flash_Controller_v1_0_S00_AXI_inst/slv_reg1} -radix hex {beef0055 0ns}

add_force {/NAND_Flash_Controller_v1_0/DIO} -radix hex {bd 500ns}
add_force {/NAND_Flash_Controller_v1_0/R_nB} -radix hex {1 0} {0 455} {1 500}
